...
if hash systemctl >/dev/null 2>&1; then
  ...
  sudo cp $SCRIPT_DIR/patches/vmware-tools-thinprint.service /etc/systemd/system/
  sudo systemctl enable vmware-tools-thinprint.service
...
echo "Installing VMware Tools with arguments $VMWARE_INSTALL_OPTIONS"
